...
parser.add_argument('--data_dst', default='coronal_pd_320_c0',
...
parser.add_argument('--rsname', '-rsn', default=None,
...
def template_set():
    if args.data_dst == 'coronal_pd_320' or args.data_dst == 'coronal_pd_320_c0' or args.data_dst == 'coronal_pd_320aug' or args.data_dst == 'sagittal_t2_320_s1':
        ...
        args.nb_train = 280
        args.nb_val = args.nb_samples - args.nb_train
    elif args.data_dst == 'IXI-T1-tf':
        print('######## Now Datasets is IXI-T1 of brain in 256 ########')
        args.data_dir = os.path.join(args.data_dir, args.data_dst)
        args.data_size = 256
        args.in_channels = 2
        args.nb_samples = 69458
        args.nb_train = 55748
        args.nb_val = args.nb_samples - args.nb_train
    elif args.data_dst == 'FSE_tf':
        print('######## Now Datasets is FSE of brain in 320 ########')
        args.data_dir = os.path.join(args.data_dir, args.data_dst)
        args.data_size = 320
        args.in_channels = 2
        args.nb_samples = 2550
        args.nb_train = 2100
        args.nb_val = args.nb_samples - args.nb_train
    elif args.data_dst == 'fastMRI_CORPD400':
        print('######## Now Datasets is fastMRI of knee in 320 ########')
        args.data_dir = os.path.join(args.data_dir, args.data_dst)
        args.data_size = 320
        args.in_channels = 30
        args.nb_samples = 400 + 40
        args.nb_train = 400
        args.nb_val = args.nb_samples - args.nb_train
...
def check_mask_name():
    if args.mask_name in ['1Ca2', '1Ca3', '1Ca4', '1Un2.98', '2Rd005', '2Rd1', '2Rd2', '2Rd3', '2Rd4',
                          ...
                          '1Un3X_256', '1Un5X_256', '1Ca3X_256', '1Ca5X_256', '2Rd3X_256', '2Rd5X_256', '2Ra3X_256', '2Ra5X_256',
                          '1Un3X_320', '1Un5X_320', '1Ca3X_320', '1Ca5X_320', '2Rd3X_320', '2Rd5X_320', '2Ra3X_320', '2Ra5X_320',
                          ]:
        args.mask_name = {'1Ca2': '1D-Cartesian-0.2',
                          ...
                          '2Dradial9': 'radial_mask_9x',
                          '1Un3X_256': '1D-Uniform-3X_256',
                          '1Un5X_256': '1D-Uniform-5X_256',
                          '1Ca3X_256': '1D-Cartesian-3X_256', 
                          '1Ca5X_256': '1D-Cartesian-5X_256',
                          '2Rd3X_256': '2D-Random-3X_256', 
                          '2Rd5X_256': '2D-Random-5X_256', 
                          '2Ra3X_256': '2D-Radial-3X_256', 
                          '2Ra5X_256': '2D-Radial-5X_256',
                          '1Un3X_320': '1D-Uniform-3X_320',
                          '1Un5X_320': '1D-Uniform-5X_320',
                          '1Ca3X_320': '1D-Cartesian-3X_320', 
                          '1Ca5X_320': '1D-Cartesian-5X_320',
                          '2Rd3X_320': '2D-Random-3X_320', 
                          '2Rd5X_320': '2D-Random-5X_320', 
                          '2Ra3X_320': '2D-Radial-3X_320', 
                          '2Ra5X_320': '2D-Radial-5X_320',
                          }.get(args.mask_name)
