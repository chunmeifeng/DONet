...
def load_data_test(data_path, batch_size):
    if args.mask_name == '1Duniform2.98_ac29' or args.mask_name == '1D-Uniform-0.3_320' or args.mask_name == '1D-Uniform-0.2_320'\
         ...
         or args.mask_name == '1D-Uniform-3X_320' or args.mask_name == '1D-Uniform-5X_320' or args.mask_name == '1D-Cartesian-3X_320' or args.mask_name == '1D-Cartesian-5X_320'\
         or args.mask_name == '2D-Random-3X_320' or args.mask_name == '2D-Random-5X_320' or args.mask_name == '2D-Radial-3X_320' or args.mask_name == '2D-Radial-5X_320':
        mask = sio.loadmat(os.path.join(args.mask_path, '{}.mat'.format(args.mask_name)))
        mask = mask['mask']
    else:
        with h5py.File(os.path.join(args.mask_path, '{}.mat'.format(args.mask_name)), 'r') as f:
